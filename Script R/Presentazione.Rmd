...
- Sono state escluse le scatole evidenziate da BrickSet come:
  - tipologia di vendita: promozionali **Promotional** e non in vendita **Not sold**
  - appartenete alla linea di prodotto **Collectable Minifigures** e **Books**
  - alla sotto linea di prodotto evidenziata come regalo **Magazine Gift** e **Gift with Purchase**
...
- <span style="color:#18a7f5;font-style: italic;">Grafico sul andamento del rapporto tra il prezzo ed il numero di pezzi per anno specifico delle linee di prodotto ricorrenti</span>
![Grafico 9](images/03_2_grafico.png){.responsive}

- Abbiamo la conferma della linea *Creator*
- Sono sicuramente interessanti le linee di prodotto: *Architecture, Ideas*

## Analisi sulle mie linee di prodotto preferite {.nofooter}
- <span style="color:#18a7f5;font-style: italic;">Grafico sul andamento del prezzo ed il numero di pezzi per la linea di prodotto Technic</span>
![Grafico 10](images/04_01_grafico.png){.responsive}

- Curioso l'andamento negli anni 2016, 2017, 2018
- Tendenza a creare scatole sempre più costose e con più pezzi

- <span style="color:#18a7f5;font-style: italic;">Grafico sul andamento del prezzo ed il numero di pezzi per la linea di prodotto Technic filtrando il prezzo tra 50€ e 250€</span>
![Grafico 11](images/04_02_grafico.png){.responsive}

- C'è una tendenza a far pagare di più le scatole a parità di n.pezzi, rispetto agli anni precedenti al 2022, 2021

- <span style="color:#18a7f5;font-style: italic;">Grafico sul andamento del prezzo ed il numero di pezzi per la linea di prodotto Creator</span>
![Grafico 12](images/04_03_grafico.png){.responsive}

- Tendenza a creare scatole sempre più costose con numero di pezzi maggiore.
...
- Una scatola che appartiene alle linee: Creator Expert, Star Wars, Icons, Ideas, Harry Potter e contiene più di 4 omini e un numero di pezzi superiore a 1688 potrebbe diventare una scatola con molte apprezzata da molte persone.
